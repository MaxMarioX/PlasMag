...
$ShowCustomerData = '
							<div class="ActionBoxTitle">
								<p style="text-align: center;">Klienci</p>
								<hr style="color: blue;">
							</div>
					   ...
					   while($DataRow = mysqli_fetch_array($ConnectStatus))  
					   {
						...
						$ShowCustomerData .= '
									    <tr onmouseover="ovStyle(this)" onmouseout="ouStyle(this)">
											<td><input type="radio" name="CustomerRadioB" value="'.$_CustomerId.'"></td>
											<td>'.$_CustomerId.'</td>
											<td>'.$CustomerName.'</td>
											<td>'.$CustomerNIP.'</td>
											<td>'.$CustomerREGON.'</td>
...
$ShowCustomerData .= '
								...
								<input type="button" name="ButtonCstData" id="ButtonCstData" value="Więcej informacji"/>
							</div>
				';				
?>
